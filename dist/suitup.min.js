...
var SuitUp=require("./suitup.js");SuitUp.Model=function(dataModelDefault){var _dataModel={}||dataModelDefault,_component={};this.setComponent=function(t){_component=t},this.getComponent=function(){return _component},this.get=function(varExp){var st="_dataModel";return!varExp.startWith("["),eval(st+varExp)},this.getData=function(){return _dataModel},this.set=function(varExp,val){var st="_dataModel";!varExp.startWith("["),eval(st+varExp+" = "+val),_component&&_component.render()};var setBoolean=function(){},setNumber=function(){},setString=function(){}},module.exports=SuitUp;
...
var SuitUp=require("./suitup.js");SuitUp.RouteResponse=function(t){var t=t;this.render=function(e){console.log(e);var i=SuitUp.ComponentRegistry.createComponentByName(t);i.setModel(e);var o='<div class="suitup-component" data-suitup-component="'+i.getId()+'">'+i.render()+"</div>",u={context:o},n=Handlebars.templates.application(u);return null==SuitUp.virtualDom?void(SuitUp.virtualDom=new SuitUp.VirtualDom(n)):void SuitUp.virtualDom.render(n)}},module.exports=SuitUp;
...
var h=require("virtual-dom/h"),diff=require("virtual-dom/diff"),patch=require("virtual-dom/patch"),createElement=require("virtual-dom/create-element"),vdom=require("vdom-virtualize"),SuitUp=require("./suitup.js");SuitUp.VirtualDom=function(e){var r=vdom.fromHTML(e),t=createElement(r);document.body.appendChild(t),this.render=function(e){var i=vdom.fromHTML(e),o=(createElement(i),diff(r,i));t=patch(t,o),r=i,console.log("done")}},module.exports=SuitUp;
